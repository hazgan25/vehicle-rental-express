...
adminRouter.put('/users/password', checkToken, checkAdmin, adminController.editPassword)
adminRouter.delete('/users/delete', checkToken, checkAdmin, adminController.deleteUser)
